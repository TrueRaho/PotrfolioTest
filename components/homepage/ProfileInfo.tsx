...
const ProfileCardInfo = () => {
  return (
    <div className="p-3">
      <h3 className="text-lg font-medium text-gray-800 dark:text-white">Anton Shyrko </h3>
      <h5 className="text-gray-700 dark:text-gray-400">Learner | Developer</h5>
      <div className="mb-2 mt-2 space-y-3">
        <div className="flex items-center">
          <Briefcase size={20} strokeWidth={1} />
          <p className="px-2">
            Fullstack Developer @{' '}
            <a className="hover:underline" target="_blank" href="https://github.com/Antot-12" rel="noreferrer">
              Anton Shyrko
            </a>
          </p>
        </div>
        <div className="flex items-center">
          ...
          <p className="px-2">
            Košice, Slovakia <Twemoji emoji="slovakia-flag" />
          </p>
        </div>
        <div className="flex items-center">
